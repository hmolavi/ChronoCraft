(function (global, factory) {
  ...
  var TL = exports.TL = function (t) {
    ...
    t.exports = function () {
      ...
      return function t() {
        ...
        return i.sanitize = function (t, n) {
          ...
          if (jt) {
            if (Ct) for (c = st.call(r.ownerDocument); r.firstChild;) c.appendChild(r.firstChild);else c = r;
      ...
      (function () {
        ...
        var Ye = function t(e) {
          ...
          function In(t, e, i, n) {
            ...
            for (t === e && (e = gr(e)), i && (s = fe(t, Ae(i))); ++a < o;) for (var l = 0, h = e[a], c = i ? i(h) : h; (l = r(s, c, l, n)) > -1;) s !== t && Vt.call(s, l, 1), Vt.call(t, l, 1);
          ...
          function nr(t, e, i) {
            ...
            for (var a = -1, o = n(r); ++a < r;) for (var s = t[a], l = -1; ++l < r;) l != a && (o[a] = Ki(o[a] || s, t[l], e, i));
          ...
          var ls = br(function (t, e) {
            if (ua(e) || Oo(e)) vr(e, bs(e), t);else for (var i in e) Tt.call(e, i) && $i(t, i, e[i]);
          }),
              hs = br(function (t, e) {
            vr(e, ws(e), t);
          }),
          ...
          var fs = Pn(function (t, e) {
            ...
            for (r && sa(e[0], e[1], r) && (n = 1); ++i < n;) for (var a = e[i], o = ws(a), s = -1, l = o.length; ++s < l;) {
              var h = o[s],
                  c = t[h];
          ...
          return Li.after = function (t, e) {
            ...
            for (var a = 0, o = 0, s = n(Ke(r / e)); a < r;) s[o++] = Un(t, a, a += e);
    ...
    const w = window && !window.L_NO_TOUCH && !o && (d || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch);
    ...
    const ut = function () {
      ...
      function C(t, e) {
        ...
        return S.apply(a, [l, function (t, n, r) {
          for (i = a.length; i--;) for (var o in u && (r = D(v[i], t), a[i].style.left = r[0] + "px", a[i].style.top = r[1] + "px"), e) n = A(t, p, d, f, o, i), "transform" == o ? a[i].style[_] = k(n) : "opacity" != o || m ? a[i].style[M(o)] = n : a[i].style.filter = "alpha(opacity=" + 100 * n + ")";
        }, o, c]);
      }
    ...
    var pt,
      ...
      return M.matches = function (t, e) {
        ...
        var n,
            ...
            o,
            s = [];
        if (O(t)) for (r = 0; r < t.length; r++) null != (n = i(t[r], r)) && s.push(n);else for (a in t) null != (n = i(t[a], a)) && s.push(n);
        ...
        attr: function (e, i) {
          ...
          return "string" == typeof e && void 0 === i ? 0 == this.length || 1 !== this[0].nodeType ? void 0 : "value" == e && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(e)) && e in this[0] ? this[0][e] : n : this.each(function (n) {
            if (1 === this.nodeType) if (N(e)) for (t in e) B(this, t, e[t]);else B(this, e, $(this, i, n, this.getAttribute(e)));
          });
        },
        ...
        css: function (i, r) {
          ...
          });else for (t in i) i[t] || 0 === i[t] ? l += z(t) + ":" + P(t, i[t]) + ";" : this.each(function () {
    ...
    const Tt = {
      ...
      floor: function (t) {
        for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < bt.length; i++) if (bt[i][2](e), bt[i][0] == t) return new Mt(e);
      ...
      findBestFormat: function (t) {
        for (var e = wt, i = 0; i < e.length; i++) if (this.data[e[i]]) return t ? t in Tt || (t = "short") : t = "base", Tt[t][e[i]];
    ...
    const Dt = [["year", 1, new St(1)], ["decade", 10, new St(10)], ["century", 100, new St(100)], ["millennium", 1e3, new St(1e3)], ["age", 1e6, new St(1e6)], ["epoch", 1e7, new St(1e7)], ["era", 1e8, new St(1e8)], ["eon", 1e9, new St(1e9)]],
          At = Mt.extend({
      initialize: function (t, e, i) {
      ...
      floor: function (t) {
        for (var e = 0; e < Dt.length; e++) if (Dt[e][0] == t) {
    ...
    class Vt {
      ...
      _makeUniqueIdentifiers(t, e) {
        for (var i = [t], n = 0; n < e.length; n++) H(e[n].unique_id) && (e[n].unique_id = $(e[n].unique_id), -1 == i.indexOf(e[n].unique_id) ? i.push(e[n].unique_id) : e[n].unique_id = "");
    ...
    class se {
      ...
      _computeDefaultSpan(t) {
        if ("human" == t.scale) {
          ...
          for (i = bt.length - 1; i >= 0; i--) if (e.hasOwnProperty(bt[i][0])) {
      ...
      _computeRowInfo(t, e) {
        for (var i = [], n = 0, r = 0; r < t.length; r++) {
          ...
          for (var s = 0; s < i.length; s++) if (o.push(i[s].end - a.start), o[s] <= 0) {
            a.row = s, i[s] = a;
            break;
          }
    ...
    let me = new class {
      ...
      load(t, e, i, n, r) {
        ...
        if (e) if (e = "string" == typeof e ? [e] : e.concat(), d || this.env.async || this.env.gecko || this.env.opera) this.queue[t].push({
          ...
          obj: n,
          context: r
        });else for (a = 0, o = e.length; a < o; ++a) this.queue[t].push({
          urls: [e[a]],
      ...
      pollWebKit() {
        ...
        if (e) {
          for (t = this.styleSheets.length; --t >= 0;) if (this.styleSheets[t].href === e.urls[0]) {
            this.finish("css");
            break;
          }
    ...
    class Xe {
      ...
      determineScriptPath() {
        ...
        if (!t) {
          ...
          for (let i = e.length - 1; i >= 0; i--) if (e[i].src) {
            t = e[i].src;
            break;
          }
        }
